...
from app.dtos.equipment_summary_dto import EquipmentSummaryDTO
...
class SiteDTO(AbstractDTO):
    ...
    def build_from_entity(entity: Site) -> "SiteDTO":
        ...
        site_dto.equipments = [EquipmentSummaryDTO.build_from_entity(equipment) for equipment in entity.equipments]
    ...
    def get_json_parsable(self):
        ...
        data["equipments"] = [equipment.get_json_parsable() for equipment in self.equipments]
        return data